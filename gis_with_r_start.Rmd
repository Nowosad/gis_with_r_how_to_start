...
m1 = tm_shape(europe) + 
  tm_polygons("gdpPercap.y") +
  tm_facets(by = "year", nrow = 1, ncol = 1, drop.units = TRUE)

animation_tmap(m1, filename = "tmp.gif", width = 2000, height = 600, delay = 40)
...
Basic **raster** operations are visualized at https://rpubs.com/etiennebr/visualraster.
